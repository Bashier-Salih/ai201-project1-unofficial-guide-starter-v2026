...
CHUNK_SIZE = 450        # characters per chunk — a ceiling, not a target
CHUNK_OVERLAP = 120     # only used by fallback_split; my chunker cuts on
                        # paragraph breaks, so it has no arbitrary cut to bridge
